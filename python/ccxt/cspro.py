...
class cspro(Exchange):

    def describe(self):
        return self.deep_extend(super(cspro, self).describe(), {
            'id': 'cspro',
            'name': 'cspro',
            'countries': ['IN'],
            'version': 'v2',
            ...
            'urls': {
                ...
                'api': {
                    'rest': 'https://coinswitch.co/pro/api/v1/realtime-rates',
                },
                'www': 'https://cspro.com',
                'doc': 'https://docs.cspro.com/#public-rest-api-for-cspro',
                'fees': 'https://cspro.com/fees',
                'referral': 'https://cspro.com/invite/k7rrnks5',
            },
            'api': {
                'public': {
                    'get': {
    ...
    def fetch_markets(self, params={}):
        """
        retrieves data on all markets for cspro
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        :param dict params: extra parameters specific to the cspro api endpoint
        ...
        extended_params=self.extend(request, params, self.request_params)
        response_raw = self.request('depth', params=extended_params, context=extended_params)
